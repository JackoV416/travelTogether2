...
const GlobalChatFAB = ({ onClick, isDarkMode, context = 'default' }) => {
    ...
    return (
        <button
            ...
            className={`fixed bottom-[max(8rem,calc(3rem+env(safe-area-inset-bottom)))] md:bottom-8 right-6 z-[150] group flex items-center justify-center w-14 h-14 rounded-2xl shadow-2xl transition-all duration-500 hover:scale-110 active:scale-95 overflow-hidden
                ${isDarkMode
