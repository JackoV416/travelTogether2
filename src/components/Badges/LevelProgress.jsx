...
const LevelProgress = ({ user, totalXP = 0 }) => {
    ...
    return (
        <AuroraCard className="mb-6 overflow-hidden !p-0" noPadding>
            <div className="bg-gradient-to-r from-indigo-900/50 via-purple-900/50 to-indigo-900/50 p-6 relative">
                {/* Background Effects */}
                    ...
                    <div className="relative">
                        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-amber-300 to-yellow-600 flex items-center justify-center shadow-lg border-4 border-white/20">
                            <div className="text-center text-white text-shadow">
                                ...
                                <div className="text-4xl font-black leading-none drop-shadow-md">{level}</div>
                            </div>
                        </div>
                        {/* Rank Star Decor */}
