...
const VERSION_HISTORY = [
    {
        ...
        date: "11/12/2025",
        desc: {
            "zh-TW": "Vercel Firebase 部署終極修正",
            "en": "Vercel Firebase Deployment Ultimate Fix"
        },
        details: {
            "zh-TW": "1. 在 Firebase 設定中加入後備值以確保 Vercel 部署正常運作。\n2. 解決 Vite 環境變數在 Vercel 中無法正確載入的問題。\n3. 確保生產環境 Firebase 認證功能完全正常。",
            "en": "1. Added fallback values in Firebase config for Vercel deployment.\n2. Fixed Vite environment variables not loading correctly on Vercel.\n3. Ensured Firebase authentication works perfectly in production."
        }
    },
    {
        ver: "V0.7.5",
        ...
        desc: {
            "zh-TW": "Vercel 部署修正",
            "en": "Vercel Deployment Fix"
        },
        details: {
            "zh-TW": "1. 移除無效的 vercel.json 檔案。\n2. 清理 Firebase 偵錯日誌。\n3. 修正 Vercel 構建錯誤。",
            "en": "1. Removed invalid vercel.json file.\n2. Cleaned up Firebase debug logs.\n3. Fixed Vercel build errors."
        }
    },
    {
        ver: "V0.7.4",
        ...
        desc: {
            "zh-TW": "全面優化選單寬度",
            "en": "Comprehensive Modal Width Improvements"
        },
        details: {
            "zh-TW": "1. 大幅提升所有彈窗選單寬度以改善可用性 (sm→lg, md→xl, 2xl→3xl)。\n2. 新增 Firebase 環境變數偵錯日誌以協助 Vercel 部署問題診斷。\n3. 改善整體使用者體驗。",
            "en": "1. Significantly increased all modal widths for better usability (sm→lg, md→xl, 2xl→3xl).\n2. Added Firebase environment variable debug logging for Vercel troubleshooting.\n3. Improved overall user experience."
        }
    },
    {
        ver: "V0.7.3",
        ...
        desc: {
            "zh-TW": "個人設定選單優化",
            "en": "Settings Modal Optimization"
        },
        details: {
            "zh-TW": "1. 修正個人設定選單寬度過窄問題 (384px → 448px)。\n2. 新增邊框與陰影效果，提升視覺層次感。\n3. 改善整體使用體驗。",
            "en": "1. Fixed settings modal width issue (384px → 448px).\n2. Added borders and shadow effects for better visual hierarchy.\n3. Improved overall user experience."
        }
    },
    {
        ver: "V0.7.2",
        ...
        desc: {
            "zh-TW": "光線模式優化與構建設定",
            "en": "Light Mode Optimization & Build Config"
        },
        details: {
            "zh-TW": "1. 大幅優化光線模式配色，將刺眼的純白色替換為柔和的淺灰色調 (gray-50/gray-100)，降低眼睛疲勞。\n2. 新增 Vite 構建設定，提高 chunk 大小警告限制至 1000kB。\n3. 改善整體視覺舒適度與可讀性。",
            "en": "1. Optimized light mode colors, replacing harsh white with soft gray tones (gray-50/gray-100) to reduce eye strain.\n2. Added Vite build config, increased chunk size warning limit to 1000kB.\n3. Improved overall visual comfort and readability."
        }
    },
    {
        ver: "V0.7.1",
        ...
        desc: {
            "zh-TW": "UI/UX 修正與優化",
            "en": "UI/UX Fixes & Optimization"
        },
        details: {
            "zh-TW": "1. 修正通知中心寬度過窄問題 (80 → 96)。\n2. 修正用戶圖標懸停選單無法顯示的 BUG (class name 空格問題)。\n3. 優化整體 UI 模糊效果，提升可讀性。\n4. 修正頁腳文字對齊問題。",
            "en": "1. Fixed notification center width issue (80 → 96).\n2. Fixed user icon hover menu not showing (broken class names).\n3. Optimized UI blur effects for better readability.\n4. Fixed footer text alignment."
        }
    },
    {
        ver: "V0.7.0",
