...
export const CITY_TRANSLATIONS = {
    ...
    "Valencia": { "zh-TW": "華倫西亞", "en": "Valencia" },
    "Zurich": { "zh-TW": "蘇黎世", "en": "Zurich" },
    "Geneva": { "zh-TW": "日內瓦", "en": "Geneva" },
    "Lucerne": { "zh-TW": "琉森", "en": "Lucerne" },
    ...
    "Phuket": { "zh-TW": "布吉", "en": "Phuket" },
    "Chiang Mai": { "zh-TW": "清邁", "en": "Chiang Mai" },
    "Pattaya": { "zh-TW": "芭堤雅", "en": "Pattaya" },
    ...
    "San Francisco": { "zh-TW": "三藩市", "en": "San Francisco" },
