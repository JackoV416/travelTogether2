...
| 版本 | 日期 | 主要更新 |
|------|------|---------| 
| **V0.16.2** | 2025-12-18 | 🐛 Bug Fixes: 修正 `CreateTripModal` 日曆選擇器 (Native Date Input，待優化為 Range Picker); ♻️ 重構: `tripUtils.js` → `tripUtils.jsx`; 🔧 Import 修正: TripDetail tabs path; 📦 Dependencies: React/useState imports |
