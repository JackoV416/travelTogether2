...
| 版本 | 日期 | 簡述 | 詳細內容 |
| :--- | :--- | :--- | :--- |
| **V0.9.0** | 15/12/2025 | 依賴更新與安全修復 | 1. 更新 React 至 v18.3.1 (LTS) 2. 更新 Vite 至 v5.1.6 3. 更新 Firebase 至 v10.12.1 4. 更新其他依賴至最新穩定版本 5. 修復安全漏洞 |
| **V0.9.0** | 2025-12-11 | AI 智能領隊 & UI 重製 | 全新 AI 模組 (行程/交通/預算分析)、UI 玻璃擬態重製 (Menus/Modals)、修復 Margin 錯位。 |
| **V0.8.6** | 2025-12-11 | 緊急修復與假期邏輯驗證 | 修復 CreateTripModal 嚴重語法錯誤導致的崩潰，修正樣式屬性，確保穩定性。 |
| **V0.8.5** | 2025-12-11 | 彈窗介面與佈局優化 | 重構 Modal 底部按鈕佈局（水平並排），修復 Padding 與邊距顯示問題，提升操作體驗。 |
| **V0.8.4** | 2025-12-11 | UI 樣式與體驗優化 | 全面修復下拉選單間距 (Margin) 問題，統一樣式標準，提升操作手感。 |
| **V0.8.3** | 2025-12-11 | 文件中心與通知系統 | 新增檔案上傳分頁 (Firebase Storage)，實作 Web Notifications，優化雙地區假期顯示與選單 UI。 |
